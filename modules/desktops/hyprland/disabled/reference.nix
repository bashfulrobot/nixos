...
with host;
{
  ...
  config = mkIf (config.hyprland.enable) {
    ...
    home-manager.users.${vars.user} =
      let
        lid = if hostName == "evo" then "LID0" else "LID";
      ...
      in
      {
        ...
        wayland.windowManager.hyprland = with colors.scheme.default.hex; {
          ...
          settings = {
            ...
            ] else if hostName == "dustin-krysak" then [
            ...
            workspace =
              ...
              ] else if hostName == "evo" || hostName == "dustin-krysak" then [
                "1, monitor:${toString mainMonitor}"
                "2, monitor:${toString mainMonitor}"
                "3, monitor:${toString mainMonitor}"
            ...
            input = {
              ...
              sensitivity = 0.8;
              touchpad =
                if hostName == "dustin-krysak" || hostName == "evo" || hostName == "probook" then {
                  natural_scroll = true;
                  scroll_factor = 0.2;
            ...
            bindl =
              if hostName == "evo" || hostName == "dustin-krysak" then [
            ...
            ] ++ (if hostName == "dustin-krysak" then [
              "${pkgs.netdustin-krysakmanagerapplet}/bin/nm-applet --indicator"
